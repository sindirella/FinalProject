...
from django.utils.html import escape  # Import the escape function for XSS prevention
from django.views.decorators.csrf import csrf_protect  # Import the csrf_protect decorator for CSRF protection
from django.views.decorators.csrf import ensure_csrf_cookie  # Import the ensure_csrf_cookie decorator
...
# @csrf_exempt
@ensure_csrf_cookie  # Ensure that the CSRF cookie is set
